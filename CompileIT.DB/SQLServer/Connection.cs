...
namespace CompileIT.DB.SQLServer
{
    ...
    public class Connection<T> : IEnumerable<T>, ICollection<T>, IList<T>
    {
        ...
        private readonly string strUsuarioBD = ConfigurationManager.AppSettings["USUARIO"].ToString();
        private readonly string strPassword = Segurity.CryptoDecrypted(ConfigurationManager.AppSettings["CLAVE"].ToString(),
                                                                            ConfigurationManager.AppSettings["USUARIO"].ToString());
        private readonly string strServidor = ConfigurationManager.AppSettings["SERVIDOR"].ToString();
        private readonly string strBaseDatos = ConfigurationManager.AppSettings["BASEDATOS"].ToString();
        ...
        public string StringConexion
        {
            get
            {
                return @"Server=" + strServidor + ";Database=" + strBaseDatos + ";User Id=" + strUsuarioBD + ";Password=" + strPassword;
            }
        }
